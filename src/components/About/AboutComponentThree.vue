<template>
      ...
      <div class="flex flex-col w-full mb-12 text-center">
        ...
        >
          <svg
            ...
            class="w-10 h-10 icon animate-spin icon-tabler icon-tabler-aperture"
            width="24"
            height="24"
            viewBox="0 0 24 24"
            stroke-width="1.5"
        ...
        >
          I create beautiful web apps that will<br class="hidden lg:block" />
          catch your users attention
        </h1>
  ...
  <section>
    <div
      class="px-4 py-12 mx-auto sm:px-6 md:px-12 lg:px-24 lg:py-24 2xl:px-12 bg-black"
    >
      <div class="flex flex-wrap items-center mx-auto 2xl:max-w-7xl">
        <div
          class="flex flex-col items-start mb-16 text-left lg:flex-grow lg:w-1/2 lg:pr-24 md:mb-0"
        >
          <span
            class="mb-8 hover:bg-indigo-200 hover:bg-opacity-10 text-xs font-bold tracking-widest text-black uppercase"
          >
            projects
          </span>
          <h1
            class="mb-8 text-4xl font-bold leading-none tracking-tighter text-indigo-600 md:text-7xl lg:text-5xl"
          >
        ...
        <div class="w-full mt-12 lg:w-5/6 lg:max-w-lg xl:mt-0">
          <div>
            <div class="relative w-full max-w-lg">
              ...
              <div class="relative">
                <img
                  class="object-cover rounded-lg hover:scale-110 transition duration-300 ease-in-out object-center mx-auto shadow-2xl"
                  alt="hero"
                  src="@/assets/saly16.png"
                />
              </div>
            </div>
          </div>
