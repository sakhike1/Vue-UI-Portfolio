    ...
    <div class="px-4 py-12 mx-auto sm:px-6 md:px-12 lg:px-24 lg:py-24 bg-black">
      <div class="flex flex-col w-full mb-12 text-center">
        <div
          ...
          <svg xmlns="http://www.w3.org/2000/svg" class="w-10 h-10 icon animate-spin icon-tabler icon-tabler-aperture"
        ...
        <p class="max-w-xl mx-auto mt-8 text-base leading-relaxed text-center text-neutral-600">
          ...
          <div class="mt-0 lg:mt-6 max-w-7xl sm:flex">
            <div class="mt-3 rounded-lg sm:mt-0">
              <a href="https://vuetify-todo-task.netlify.app/#/"
                class="border space-x-4 text-white text-center py-4 px-10 rounded-full" v-wave="{ color: 'gray' }">See
                projects</a>
            </div>
            ...
            <div class="relative w-full max-w-lg">
              ...
              <div class="relative">
                <img
                  ...
                  alt="hero" src="@/assets/saly16.png" />
              </div>
            </div>
          </div>
        </div>
