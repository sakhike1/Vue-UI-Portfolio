  ...
  >
    ...
    <section class="bg-black">
      ...
      >
        <div class="mt-6">
          <div
            class="inline-flex w-full overflow-hidden rounded-lg shadow sm:w-auto sm:mx-3"
          >
          </div>

          <div
            class="inline-flex w-full mt-4 overflow-hidden rounded-lg shadow sm:w-auto sm:mx-3 sm:mt-0"
          >
          </div>
        </div>
      </div>
          ...
          <div class="p-8 bg-white rounded-lg shadow-lg lg:p-12 lg:col-span-3">
            <form class="space-y-4">
              <div>
                ...
                <input
                  class="w-full p-3 text-sm border-yellow rounded-lg"
                  placeholder="Name"
                  type="text"
                  id="name"
                />
              ...
              <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div>
                  <label class="sr-only v-model" for="phone">Phone</label>
                  <input
                    class="w-full p-3 text-sm border-yellow rounded-lg"
              ...
              <div>
                <label class="sr-only v-model" for="message ">Message</label>
                <textarea
                  class="w-full p-3 text-sm border-yellow rounded-lg"
                  placeholder="Message"
                  rows="8"
              ...
              <div class="mt-4 border-black">
                <button
                  @click.="(event) => warn('email has been submitted.', event)"
                  type="submit"
                ...
                >
                  <span class="font-medium v-model"> Send Message </span>
