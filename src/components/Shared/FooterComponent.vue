<template>
  <footer
    class="text-white bg-gradient-to-r from-green-300 via-blue-500 to-purple-600 hover:from-pink-500 hover:to-yellow-500">
    <div class="max-w-screen-xl px-4 pt-32 pb-12 mx-auto sm:px-6 lg:px-8">
      <div class="max-w-3xl mx-auto text-center">
        ...
        <a class="inline-block px-12 py-3 mt-8 text-sm font-medium border rounded-full border-white/25 hover:bg-white hover:text-yellow-500"
          href="/#Contact">
          Contact me
        </a>
      </div>
      ...
      <div class="pt-12 mt-32 border-t border-white/25 sm:items-center sm:justify-between sm:flex">
        ...
        <div class="flex justify-center mt-6 space-x-6 sm:justify-end sm:mt-0">
          <a class="p-2 border rounded-full border-white/25 hover:opacity-75" href="" target="_blank" rel="noreferrer">
            ...
            <svg class="w-6 h-6 text-blue fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512">
              <path
