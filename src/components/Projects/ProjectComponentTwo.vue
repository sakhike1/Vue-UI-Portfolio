    ...
    <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 gap-4 md:gap-6 xl:gap-8">
        ...
        >
          ...
          <div
            class="bg-gradient-to-r from-green-300 via-black-500 to-purple-600 via-transparent opacity-50 absolute inset-0 pointer-events-none"
          >
          </div>
        </a>
        ...
        >
          ...
          <div
            class="bg-gradient-to-r from-pink-500 via-black-500 via-transparent to-transparent opacity-50 absolute inset-0 pointer-events-none"
          >
          </div>
        </a>
      </div>
